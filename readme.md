...
- [Atomic Agent](https://github.com/AtomicBot-ai/atomic-agent) - A local-first coding agent whose TUI has an interactive chat log, model picker, provider wizard, approval prompts, and tabbed panels.

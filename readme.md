...
- [ink-select-input-horizontal](https://github.com/H3RSKO/ink-select-input-horizontal) - Mod of the above componenet adding color and orientation customization.
